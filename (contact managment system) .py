...
def DisplayForm():
    ...
    display_screen.title("By Pranav presents")
    global tree
    global SEARCH
    ...
    #label for heading
    lbl_text = Label(TopViewForm, text="CONTACTS", font=('verdana', 18), width=600,bg="pink")
    ...
    btn_search = Button(LeftViewForm, text="Search", command=SearchRecord,bg="pink")
    ...
    btn_delete = Button(LeftViewForm, text="Update", command=Update,bg="blue")
    btn_delete.pack(side=TOP, padx=10, pady=10, fill=X)
    #setting scrollbar
